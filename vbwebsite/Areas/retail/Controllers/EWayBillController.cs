...
namespace vbwebsite.Areas.retail.Controllers
{
    public class EWayBillController : Controller
    {
        ...
        public RetEWayBill GenerateEWB(RetDetailsForEWB data, long orderId, string invoiceNumber, long UserId = 1)
        {
            ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
            ...
            RetEWayBill eWBResponse = new RetEWayBill();
            //Generate Ewb By IRN
            ...
            // reqPlGenEwbByIRN.ExpShipDtls.Loc = item.To_State;
            ...
            if (txnRespWithObj.IsSuccess)
            {
                ...
                eWBResponse.EWayBillNumber = txnRespWithObj.RespObj.EwbNo;
                ...
                _orderService.AddRetEWayBill(eWBResponse);

                UpdateEWBNumber(invoiceNumber, orderId, txnRespWithObj.RespObj.EwbNo);
                EWBDetailedPrint(txnRespWithObj.RespObj.EwbNo);
            }
            else
            {
        ...
        public void UpdateEWBNumber(string invoiceNumber, long orderId, long EwbNo)
        {
            SqlCommand cmdGet = new SqlCommand();
            BaseSqlManager objBaseSqlManager = new BaseSqlManager();
            cmdGet.CommandType = CommandType.StoredProcedure;
            cmdGet.CommandText = "UpdateRetEWBNumber";
        ...
        //{
        //    ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
        //    var pdfFolderPath = Path.Combine(System.Web.HttpContext.Current.Server.MapPath(@"~/EWayBill/"));
        //    string filename = EwbNo + ".pdf";
        //    var logFilePath = Path.Combine(System.Web.HttpContext.Current.Server.MapPath(@"~/EWayBill/log.txt"));
        //    using (StreamWriter w = System.IO.File.AppendText(logFilePath))
        //    {
        //        Log(pdfFolderPath + filename, w);
        //    }
        ...
        //        //if (System.Configuration.ConfigurationManager.AppSettings["HostingEnvironment"].ToString() == HostingEnvironment.localhost.ToString())
        //        //{
        //        //    path = "http://" + System.Web.HttpContext.Current.Request.Url.Host + ":6551/EWayBill/" + filename;
        //        //    using (StreamWriter w = System.IO.File.AppendText(logFilePath))
        //        //    {
        //        //        Log(path, w);
        //        //    }
        ...
        //        //{
        //        //    path = "http://" + System.Web.HttpContext.Current.Request.Url.Host + "/EWayBill/" + filename;
        //        //    using (StreamWriter w = System.IO.File.AppendText(logFilePath))
        //        //    {
        //        //        Log(path, w);
        //        //    }
        ...
        //        //else
        //        //{
        //        //    path = "https://" + System.Web.HttpContext.Current.Request.Url.Host + "/EWayBill/" + filename;
        //        //    using (StreamWriter w = System.IO.File.AppendText(logFilePath))
        //        //    {
        //        //        Log(path, w);
        //        //    }
        ...
        //        using (StreamWriter w = System.IO.File.AppendText(logFilePath))
        //        {
        //            //Log(EwbSession.EwbApiLoginDetails.EwbAuthToken, w);
        //            Log(string.Format("AuthToken : {0}, \n EwbUserID : {1}, \n EWBPassword : {2}, \n Gstin : {3}, \n GSPName : {4}, \n AspUserId : {5}, \n AspPassword : {6}, \n BaseURL : {7} ",
        //                EwbSession.EwbApiLoginDetails.EwbAuthToken,
        //                EwbSession.EwbApiLoginDetails.EwbUserID,
        //                EwbSession.EwbApiLoginDetails.EwbPassword,
        //                EwbSession.EwbApiLoginDetails.EwbGstin,
        //                EwbSession.EwbApiSetting.GSPName,
        //                EwbSession.EwbApiSetting.AspUserId,
        //                EwbSession.EwbApiSetting.AspPassword,
        //                EwbSession.EwbApiSetting.BaseUrl), w);
        //        }
        ...
        //        using (StreamWriter w = System.IO.File.AppendText(logFilePath))
        //        {
        //            Log(EWBSession.GspApiBaseUrl, w);
        //        }
