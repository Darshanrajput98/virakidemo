...
namespace vbwebsite.Areas.expenses.Controllers
{
    public class SupplierController : Controller
    {
        ...
        [HttpPost]
        public ActionResult AddSupplier(AddExpenseSupplier data)
        {
            string response = "";
            try
            {
                ...
                else
                {
                    ...
                    response = (_ISupplierService.AddExpenseSupplier(data)).ToString();
        ...
        {
            List<ExpenseSupplierListResponse> objModel = _ISupplierService.GetAllExpenseSupplierList();
            return PartialView(objModel);
        }

        public ActionResult GetSupplierAddressOneList(long SupplierID)
        {
            List<ExpenseSupplierContactDetail> lstSupplierAddress = _ISupplierService.GetExpenseSupplierAddressListBySupplierID(SupplierID);
        ...
        public ActionResult DeleteSupplier(long? SupplierID, bool IsDelete)
        {
            try
            {
                _ISupplierService.DeleteExpenseSupplier(SupplierID.Value, IsDelete);
        ...
        {
            var CustomerList = _ISupplierService.GetAllExpenseSupplierList();
            List<ExpenseSupplierListExport> lstproduct = CustomerList.Select(x => new ExpenseSupplierListExport()
            {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= " + "ExpenseSupplierList.xls");
