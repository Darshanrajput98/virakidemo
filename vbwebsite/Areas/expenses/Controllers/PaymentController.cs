...
namespace vbwebsite.Areas.expenses.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public ActionResult ExpensePayment()
        {         
        ...
        [HttpPost]
        public PartialViewResult ViewExpensePaymentList(ExpensePaymentListResponse model)
        {
            ViewBag.CashOption = _ICommonService.GetAllCashOption();
            ViewBag.BankName = _ICommonService.GetBankNameList();
            List<ExpensePaymentListResponse> objModel = _IPaymentService.GetAllExpensePaymentList(model);
            return PartialView(objModel);
        }

        [HttpPost]
        public ActionResult SavePayment(List<ExpensePaymentListResponse> data)
        {
            ...
            else
            {
                ...
                bool respose = _IPaymentService.SaveExpensePayment(data, UserID);
