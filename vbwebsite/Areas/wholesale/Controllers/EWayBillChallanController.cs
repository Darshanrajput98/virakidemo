...
namespace vbwebsite.Areas.wholesale.Controllers
{
    public class EWayBillChallanController : Controller
    {
        ...
        // GET: /wholesale/EWayBillChallan/
        public ActionResult Index()
        {
            return View();
        }

        public EWayBillChallan GenerateEWB(ChallanDetailForEWB ChallanDetails, List<ChallanItemForEWB> lstChallanItems, long UserId)
        {
            ...
            EWayBillChallan eWBResponse = new EWayBillChallan();
            ...
            if (TxnResp.IsSuccess)
            {
                ...
                _orderService.AddEWayBillChallan(eWBResponse);
