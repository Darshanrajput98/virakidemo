...
namespace vbwebsite.Areas.retail.Controllers
{
    public class EInvoiceController : Controller
    {
        ...
        public RetEInvoice GenIRN(RetOrderQtyInvoiceList orderData, List<RetOrderQtyInvoiceList> lstData)
        {
            ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
            ...
            string invoiceNumber2 = string.Empty;

            invoiceNumber2 = lstData[0].EInvoiceNumber;  // with out year
            invoiceNumber = lstData[0].InvoiceNumber;

            orderId = lstData[0].OrderID;


            // GetEDetails(orderId, invoiceNumber2);
            ...
            //reqPlGenIRN.DocDtls.No = "R" + lstData[0].EInvoiceNumber; // with out year
            reqPlGenIRN.DocDtls.No = "R" + lstData[0].InvoiceNumber;
            ...
            if (txnRespWithObj.IsSuccess)
            {
                ...
                eInvoice.InvoiceNumber = invoiceNumber2;
                ...
                _orderService.AddRetEInvoice(eInvoice);


                // Update e-invoice error status
                UpdateRetEInvoiceError(invoiceNumber, orderId);
            ...
            else
            {
                ...
                if (txnRespWithObj.ErrorDetails != null)
                {
                    ...
                    RetEInvoiceErrorDetails_Mst obj = new RetEInvoiceErrorDetails_Mst();
                    ...
                    using (VirakiEntities context = new VirakiEntities())
                    {
                        context.RetEInvoiceErrorDetails_Mst.Add(obj);
                        context.SaveChanges();
                    }
                    // 13 April, 2021 Piyush Limbani (Error For E-Invoice)
        ...
        public bool DeleteRetEInvoice(string IRN, long OrderID, string InvoiceNumber, long UpdatedBy, DateTime UpdatedOn)
        {
            ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
            ...
            if (txnRespWithObj.IsSuccess)
            {
                ...
                BaseSqlManager objBaseSqlManager = new BaseSqlManager();
                cmdGet.CommandType = CommandType.StoredProcedure;
                cmdGet.CommandText = "DeleteRetEInvoice";
                ...
                cmdGet1.CommandText = "DeleteRetOrderQty";
                ...
                //    cmdGet2.CommandText = "DeleteRetInvoiceFromPayment";
                //    cmdGet2.Parameters.AddWithValue("@InvoiceNumber", InvoiceNumber);
                //    cmdGet2.Parameters.AddWithValue("@OrderID", OrderID);
        ...
        private void UpdateRetEInvoiceError(string InvoiceNumber, long OrderID)
        {
            SqlCommand cmdGet = new SqlCommand();
            BaseSqlManager objBaseSqlManager = new BaseSqlManager();
            cmdGet.CommandType = CommandType.StoredProcedure;
            cmdGet.CommandText = "UpdateRetEInvoiceError";
        ...
        //public void GetEDetails(long orderId, string invoiceNumber2)
        //{
        //    eInvSession = eCred.SaveSettings();
        //    eInvSession = eCred.SaveLoginDetails();
        //    string IrnNo = "6ebf0beefeec180ea6d2a5defe1487bb0dadf10f0cd178e9055d483d543717d6";
