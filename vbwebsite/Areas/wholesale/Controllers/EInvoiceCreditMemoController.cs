...
namespace vbwebsite.Areas.wholesale.Controllers
{
    public class EInvoiceCreditMemoController : Controller
    {
        ...
        // GET: /wholesale/EInvoiceCreditMemo/
        ...
        public EInvoiceCreditMemo GenIRN(OrderQtyInvoiceList orderData, List<OrderQtyInvoiceList> lstData)
        {
            ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
            ...
            reqPlGenIRN.DocDtls.Typ = "CRN";  //lstData.DocType;
            ...
            foreach (var data in lstData)
            {
                if (data.ProductName != "")
                {
                    ...
                    itm.Discount = 0;  // 12 June, 2021 Piyush Limbani
            ...
            if (txnRespWithObj.IsSuccess)
            {
                ...
                _orderService.AddEInvoiceCreditMemo(eInvoice);
        ...
        public bool DeleteEInvoiceCreditMemo(string IRN, string CreditMemoNumber, bool IsDelete, long UpdatedBy, DateTime UpdatedOn)
        {
            ...
            if (txnRespWithObj.IsSuccess)
            {
                ...
                BaseSqlManager objBaseSqlManager = new BaseSqlManager();
                cmdGet.CommandType = CommandType.StoredProcedure;
                cmdGet.CommandText = "DeleteEInvoiceCreditMemo";
                ...
                cmdGet1.CommandText = "DeleteCreditMemo";
